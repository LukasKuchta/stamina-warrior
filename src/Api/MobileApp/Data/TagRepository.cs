...
public class TagRepository
{
    ...
    public async Task<bool> IsAssociated(Tag item, int projectID)
    {
        await Init();
        ...
        int existingCount = Convert.ToInt32(await checkCmd.ExecuteScalarAsync(), CultureInfo.InvariantCulture);
